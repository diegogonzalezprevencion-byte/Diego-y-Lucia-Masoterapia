...
export const metadata = {
  title: "Masoterapia Profesional en Providencia",
  description: "Masajes relajantes, descontracturantes, linfáticos y bienestar corporal en Providencia."
};
      ...
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <h1>Masoterapia Profesional en Providencia</h1>
            <p>Masajes relajantes, descontracturantes, linfáticos y bienestar corporal en Providencia.</p>
            <p><Link className="btn secondary" href="/agenda-masoterapia">Agendar Masoterapia</Link></p>
          </div>
          <div className="visual-card">
            <div className="visual-placeholder">Imagen sugerida para Masoterapia Profesional en Providencia</div>
          </div>
        </div>
      </section>
