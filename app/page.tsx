...
export default function Home() {
  ...
  const serviceCards = [
    ["Masaje Relajante", "60 min", "$35.000", "Relajación general, disminución de tensión y pausa de bienestar."],
    ["Masaje Descontracturante", "60 min", "$40.000", "Trabajo focalizado en zonas de tensión muscular."],
    ["Masaje Mixto", "90 min", "$50.000", "Combinación relajante y descontracturante."],
    ["Masaje con Piedras Calientes", "75 min", "$48.000", "Relajación profunda con termoterapia superficial."],
    ["Piernas Cansadas", "45 min", "$30.000", "Sensación de alivio, descarga y descanso de piernas."],
    ["Masaje Craneal", "30 min", "$25.000", "Relajación de cuero cabelludo, cuello y zona alta."],
    ["Masaje para Bruxismo", "45 min", "$35.000", "Apoyo complementario para relajar musculatura facial y mandibular."],
    ["Masaje para Parálisis Facial", "45 min", "$35.000", "Apoyo suave complementario, idealmente con indicación profesional previa."],
    ["Masaje Linfático", "60 min", "$42.000", "Técnica manual suave orientada a drenaje y bienestar."],
    ["Masaje Reductivo", "60 min", "$40.000", "Técnica estética corporal localizada, no invasiva."]
  ];
      ...
      <section className="section soft" id="servicios">
        <div className="container">
          ...
          <div className="grid-3" style={{ marginTop: 28 }}>
            {serviceCards.map(([name, duration, price, description], index) => (
