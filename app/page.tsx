...
export default function Home() {
  const services = [
    ...
    "Masaje Mixto - $50.000",
    "Masaje relajante más piedras caliente - $48.000",
  ...
  const serviceCards = [
    ...
    ["Masaje relajante más piedras caliente", "75 min", "$48.000", "Relajación profunda con termoterapia superficial.", "/servicio-piedras.png"],
  ...
  return (
    <main>
      ...
      <section className="section soft services-compact-section" id="servicios">
        <div className="container">
      ...
      <section className="section dark process-wellness-section" id="bienestar-integral">
        <div className="container process-wellness-split">
          <div className="process-wellness-content">
            <div className="eyebrow">Proceso de atención</div>
            <h2>Una experiencia de bienestar ordenada y profesional</h2>
            <div className="process-compact-grid" style={{ marginTop: 22 }}>
...
<section className="section alt">
        <div className="container">
          <div className="cta enhanced-contact-cta">
            ...
            <div className="cta-contact-info" aria-label="Información de contacto de Umbral Corporal">
              <h3>Contacto y redes</h3>
              <a href="tel:+56950257518"><span>WhatsApp / Teléfono</span><strong>+56 9 5025 7518</strong></a>
              <a href="mailto:contacto@umbralcorporal.cl"><span>Correo</span><strong>contacto@umbralcorporal.cl</strong></a>
              <a href="https://www.instagram.com/umbral_corporal/" target="_blank" rel="noopener noreferrer"><span>Instagram</span><strong>@umbral_corporal</strong></a>
            </div>
          </div>
        </div>
      </section>
