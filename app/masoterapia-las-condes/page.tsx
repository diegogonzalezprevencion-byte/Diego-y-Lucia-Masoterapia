...
export const metadata = {
  title: "Masoterapia Profesional en Las Condes",
  description: "Servicios de masaje profesional y bienestar corporal en Las Condes."
};
      ...
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <h1>Masoterapia Profesional en Las Condes</h1>
            <p>Servicios de masaje profesional y bienestar corporal en Las Condes.</p>
            <p><Link className="btn secondary" href="/agenda-masoterapia">Agendar Masoterapia</Link></p>
          </div>
          <div className="visual-card">
            <div className="visual-placeholder">Imagen sugerida para Masoterapia Profesional en Las Condes</div>
          </div>
        </div>
      </section>
