      ...
      <main>
        <section className="section">
          <div className="container">
            ...
            <p>Gestiona reservas de masoterapia, disponibilidad, contactos, recordatorios, testimonios, ofertas mensuales y métricas.</p>
            <div className="grid-3" style={{ marginTop: 28 }}>
              ...
              <div className="card"><h2>Contactos</h2><Link className="btn" href="/admin/contactos">Gestionar formularios</Link></div>
              ...
              <div className="card"><h2>Ofertas mensuales</h2><Link className="btn secondary" href="/admin/ofertas">Modificar ofertas</Link></div>
            </div>
          </div>
        </section>
      </main>
