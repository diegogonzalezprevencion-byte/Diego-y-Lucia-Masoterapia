...
import { reminder24hMessage, reminderSameDayMessage } from "../../../../lib/whatsapp";
...
function mapReminders(rows: any[], today: string, tomorrow: string) {
  return rows.map((reserva: any) => {
    ...
    const reminderMessage = reminderType === "same_day" ? reminderSameDayMessage(reserva) : reminder24hMessage(reserva);
