...
- v38: Se agregó información de contacto y redes sociales en la sección “¿Quieres reservar o resolver una duda?”, con teléfono/WhatsApp, correo corporativo e Instagram.
- v39: Se reemplazó el calendario de tarjetas por un calendario mensual compacto con selector de mes limitado a mes en curso y mes siguiente. Los días disponibles se muestran en verde y los días sin agenda o pasados en rojo. El calendario queda arriba, los datos de contacto abajo y el resumen al final.

- v40: Se amplió el ancho general del sitio para aprovechar mejor los laterales. En la agenda pública, los filtros de sucursal y masoterapeuta se movieron al bloque del calendario, justo debajo del filtro de mes, ya que ahora afectan la disponibilidad mostrada.
- v41: Se agregó analítica web para registrar visitas públicas, visitantes únicos aproximados, sesiones, clics en botones/enlaces, origen del tráfico y parámetros UTM. El Dashboard incorpora una nueva sección de evaluación con filtros por fecha, tipo de evento y ruta/página. Incluye migración `supabase/migracion_v41_analytics.sql`.
- v42: Se mejoró el correo automático al confirmar reservas desde el panel administrador. El mensaje al cliente incluye servicio, fecha, hora, lugar/sucursal, masoterapeuta y valor, usando como remitente configurado contacto@umbralcorporal.cl.
