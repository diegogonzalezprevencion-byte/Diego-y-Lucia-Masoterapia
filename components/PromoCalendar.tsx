...
const monthlyCampaigns = [
  ...
  { month: "Agosto", title: "Agosto con 20% de descuento", service: "20% de descuento · Todos los masajes", idea: "Durante agosto, agenda cualquier tipo de masaje y recibe un 20% de descuento. El descuento se aplica automáticamente al seleccionar una fecha de agosto en la agenda. Válido solo durante agosto.", accent: "back" },
