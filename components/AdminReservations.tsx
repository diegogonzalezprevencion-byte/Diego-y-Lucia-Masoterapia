  ...
  async function updateStatus(id: string, estado: string) {
    ...
    try {
      ...
      if (estado === "confirmada") {
        if (emailStatus?.sent) {
          setSuccess("Reserva confirmada y correo de confirmación enviado al cliente desde contacto@umbralcorporal.cl.");
        } else if (emailStatus?.skipped) {
          setSuccess("Reserva confirmada.");
          setError(`Correo no enviado: ${emailStatus.reason}`);
        } else if (emailStatus?.error) {
          setSuccess("Reserva confirmada.");
          setError(`La reserva quedó confirmada, pero no se pudo enviar el correo: ${emailStatus.error}`);
        } else {
          setSuccess("Reserva confirmada.");
        }
