      ...
      <div className="table-wrap" style={{ marginTop: 18 }}>
        <table className="table reminders-table">
          ...
          <tbody>
              ...
              <tr key={item.id + item.reminderType}>
                ...
                <td>
                  <div className="admin-actions">
                    <a className="btn whatsapp" href={buildWhatsAppUrlForNumber(item.telefono, item.reminderMessage)} target="_blank" rel="noopener noreferrer">
            ...
            {!loading && items.length === 0 && <tr><td colSpan={6}>No hay recordatorios pendientes.</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
