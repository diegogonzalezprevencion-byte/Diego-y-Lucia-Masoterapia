    ...
    <div className="grid-2">
      <div className="card">
        ...
        <form className="form" onSubmit={create}>
          ...
          <label className="label">Hora<select className="select" value={hora} onChange={(e) => setHora(e.target.value)}>{["09:00", "10:00", "11:00", "12:00", "15:00", "16:00", "17:00", "18:00"].map((slot) => <option value={slot} key={slot}>{slot}</option>)}</select></label>
